...
public class LpMockLab {
    ...
    // Escreen
    public void EscreenStatusPost(String sqlID, String regID, int statusNumber) {
        try {
    ...
    public void EscreenResultPost(String sqlID, String regID, String specimenId) {
        try {
    ...
    // Quest
    public void QuestStatusPost(String regID, String status) {
        try {
    ...
    public void QuestCocPost(String registrationID, String specimenId) {
        String cocquest = propreader.getProperty("QuestCocBody");
        try {
            HttpResponse<String> response = Unirest.post("http://qatlsvc03:8080/vif-receiver/results/coc/quest")
                    ...
                    .body("<soapenv:Envelopexmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\"xmlns:qcs=\"https://qcs-uat.questdiagnostics.com\"><soapenv:Header/><soapenv:Body><qcs:ReceiveLabTestResult><userName>quest</userName><password>p@55w0rd</password><LabTestResultXml><Donor><ResultState>1</ResultState><OrderClient><ClientNumber>41107405</ClientNumber><ClientName>PROVIDENCERI-NATL</ClientName><ClientAttn>MANPOWER-HRCONTACT</ClientAttn><ClientAccountDescription>MPOC</ClientAccountDescription><Address><StreetAddress>1375PARKAVES3,</StreetAddress><City>CRANSTON</City><State>RI</State><Zip>02920</Zip><Phone>000-000-0000</Phone><Fax/></Address></OrderClient><Specimen><ReferenceTestID>"+registrationID+"</ReferenceTestID><RequisitionNumber>7174789</RequisitionNumber><UniqueRequisitionID>7174789761544PBL</UniqueRequisitionID><LabAccessionNumber>761544P</LabAccessionNumber><DonorPrimaryID>984774747</DonorPrimaryID><DonorSecondaryID>test,nojuri</DonorSecondaryID><ReasonForTest>PRE-EMPLOYMENT</ReasonForTest><DonorVerificationFlag>1</DonorVerificationFlag><SpecimenCollectionDate>20190207</SpecimenCollectionDate><SpecimenCollectionTime>1039</SpecimenCollectionTime><SpecimenReceivedDate>20190207</SpecimenReceivedDate><SpecimenReceivedTime>1000</SpecimenReceivedTime></Specimen><ClientSiteLocation><ClientSiteLocationID/><Address><Name/><StreetAddress/><StreetAddress2/><StreetAddress3/></Address></ClientSiteLocation><Reporting><ReportDate>20190207</ReportDate><ReportTime>1001</ReportTime><ResultsIndicator>YNNNNNN</ResultsIndicator><ReportVerificationTimestamp>201902071001</ReportVerificationTimestamp><SpecimenID>"+specimenId+"</SpecimenID>"+ cocquest)
                    .asString();
            String resp = response.getBody();
            resp = resp.replaceAll("\"", "");
            System.out.println(resp);
    ...
    public void QuestResultPost(String specimendId) {
        try {
